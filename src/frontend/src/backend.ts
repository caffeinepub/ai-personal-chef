...
export class Backend implements backendInterface {
    ...
    async searchRecipes(arg0: Array<string>, arg1: boolean | null, arg2: bigint | null, arg3: string | null): Promise<Array<RecipeMatch>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchRecipes(arg0, to_candid_opt_n6(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n7(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n8(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
